    ...
    <div class="col-md-12">
      ...
      <div class="card card-primary card-outline mb-4">
        ...
        <div class="card-header">
          <div class="card-title">Add New Social Link</div>
          <div style="display: flex;justify-content: end;">
            <a href="{{ route('admin.socialLinks.index') }}" class="btn btn-outline-primary">
              <i class="fas fa-arrow-left mr-1"></i> Back to Social Links</a>
          </div>
        </div>
        <!--end::Header-->
        <!--begin::Form-->
        <form action="{{ route('admin.socialLinks.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-12 mb-3">
                ...
                <input type="text" name="icon_class" class="form-control @error('icon_class') is-invalid @enderror"
                  value="{{ old('icon_class') }}" placeholder="e.g. fab fa-facebook-f">
                @error('icon_class')
                  <span class="text-danger">{{ $message }}</span>
                @enderror
              </div>
